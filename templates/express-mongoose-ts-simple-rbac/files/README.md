...
Express + Mongoose API (TypeScript) with a layered architecture, JWT auth, and simple role-based access control.
...
There's no self-service way to become an admin (by design). Promote a user after they've registered:
