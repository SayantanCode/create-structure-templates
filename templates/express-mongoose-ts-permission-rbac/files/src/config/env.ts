...
const envSchema = Joi.object({
  ...
  // (see test/setup.ts) and never read this value, so it only needs to be a
...
export const env = {
  ...
  MONGO_URI: envVars.MONGO_URI as string,
  JWT_ACCESS_SECRET: envVars.JWT_ACCESS_SECRET as string,
