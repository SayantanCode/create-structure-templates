...
export function createServer() {
  ...
  // Structured, leveled request logging — pick a library in the
  // "logging" dimension (Pino by default, Winston as an alternative) to
  // populate this with a request-scoped req.log other middleware/handlers
  // can log through too. Leave "None" selected for bare console logging
  // with no per-request access log.
  // __COMPOSER_REQUEST_LOGGER__
