...
// Both the API process (enqueueing jobs, via queues/email.queue.js) and
// the standalone worker process (workers/email.worker.js) construct a
...
// Worker instance instead (see loaders/index.js and worker.js).
